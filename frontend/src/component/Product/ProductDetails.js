...
const ProductDetails = ({ match }) => {
    ...
    const addToCartHandler = () => {
        ...
        alert.success("Mặt hàng đã được thêm vào giỏ hàng");
    };
    ...
    return (
        <Fragment>
            {loading ? (
                ...
                <Fragment>
                    <MetaData title={`${product.name} -- cửa hàng thời trang`} />
                    <div className="ProductDetails">
                        ...
                        <div>
                            ...
                            <div className="detailsBlock-4">
                                Miêu tả sản phẩm : <p>{product.description}</p>
                            </div>
                    ...
                    >
                        ...
                        <DialogActions>
                            <Button onClick={submitReviewToggle} color="secondary">Hủy bỏ</Button>
                            <Button onClick={reviewSubmitHandler} color="primary">Gửi</Button>
                        </DialogActions>
                    </Dialog>
